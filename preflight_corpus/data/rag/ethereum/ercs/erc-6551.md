...
interface IERC6551Registry {
     ...
     *
     * @return account The address of the token bound accoun
     */
...
interface IERC6551Executable {
     ...
     * @param value     The Ether value to be sent to the targe
    ...
    function createAccount(
        ...
        assembly {
            ...
            if iszero(extcodesize(computed)) {
                ...
                // Emit the ERC6551AccountCreated even
                log4(
                    0x6c,
                    0x60,
