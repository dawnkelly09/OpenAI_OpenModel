 ...
 interface ERCRulesEngine {
    ...
    */
    ...
    /**
        ...
        @param _owner           Owner/ID of the RuleTree
        @param _ruleSetName     ID/Name of the RuleSe
        @param _desc            Verbose description of the RuleSe
    ...
    */
    ...
    /**
        @notice Retrieves the properties of a RuleSe
        @param _owner        Owner/ID of the RuleTree
        @param _ruleSetName  ID/Name of the RuleSe
        @return string       Verbose description of the RuleSe
        ...
        @return uint         Indicates the number of rules hosted by this RuleSe
        @return bytes32[]    The list of RuleSets that are children of this RuleSe
    */
