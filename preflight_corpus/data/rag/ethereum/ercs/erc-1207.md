...
* `funcNames`: a list of function names callable by the granted contrac
...
```
Required - userAuth maps (authorizer address, grantee contract address) pair to the user’s authorization AuthInfo objec
...
* return: Whether the callableFuncNames is updated or no
...
```
Required - check the invoke method authority for the client contrac
...
* return: Whether the grantee request is authorized or no
* This method MUST return success or throw, no other outcomes can be possible
...
* return: Whether the grant is successful or no
* This method MUST return success or throw, no other outcomes can be possible
...
* `_grantee`: the client contract address
* return: Whether the revoke is successful or no
