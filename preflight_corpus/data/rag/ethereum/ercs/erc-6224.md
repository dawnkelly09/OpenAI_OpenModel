...
interface IContractsRegistry {
     ...
     * @param name the name of the contrac
     * @param contractAddress the address of the added contrac
     */
     ...
     * @param name the name of the contrac
     * @param contractAddress the address of the proxy contrac
     * @param implementation the address of the implementation contrac
     */
     ...
     * @param name the name of the contrac
     * @param newImplementation the address of the new implementation contrac
     */
     ...
     * @param name the name of the removed contrac
     */
     ...
     *
     * @param name the name of the contrac
     * @return the address of the contrac
     */
     ...
     *
     * MUST call the `setDependencies()` with `address(this)` and `bytes("")` as arguments on the provided contrac
     *
     * @param name the name of the contrac
     */
     ...
     *
     * MUST call the `setDependencies()` with `address(this)` and `data` as arguments on the provided contrac
     *
     * @param name the name of the contrac
     * @param data the extra context data that will be passed to the dependant contrac
     */
     ...
     *
     * MUST emit `ProxyContractUpgraded` even
     *
     * @param name the name of the proxy contrac
     ...
     *
     * @param name the associated name with the contrac
     */
...
interface IDependant {
     ...
     * @param data the extra data that might provide additional application-specific contex
     */
