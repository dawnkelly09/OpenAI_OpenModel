...
interface IERC4671 is IERC165 {
    ...
    /// @notice Check if an address owns a valid token in the contrac
...
interface IERC4671Metadata is IERC4671 {
    /// @return Descriptive name of the tokens in this contrac
    function name() external view returns (string memory);

    /// @return An abbreviated name of the tokens in this contrac
...
interface IERC4671Enumerable is IERC4671 {
    ...
    /// @notice Get the tokenId of a token using its position in the owner's lis
...
interface IERC4671Delegate is IERC4671 {
    ...
    /// An allowed operator can call the function to transfer rights.
    /// @param operators Addresses allowed to min
...
interface IERC4671Consensus is IERC4671 {
    /// @notice Get voters addresses for this consensus contrac
...
interface IERC4671Pull is IERC4671 {
    /// @notice Pull a token from the owner wallet to the caller's walle
