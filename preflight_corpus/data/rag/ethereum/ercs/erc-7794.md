...
interface IGrantRegistry {
  ...
  /**
   * @dev Registers a new grant with the provided details. `grantId` is generated by hashing the gran
   ...
   * @param grantId The unique identifier of the gran
  ...
  /**
   * @dev Retrieves the current grant manager for a specific gran
   * @param grantId The unique identifier of the gran
  ...
  /**
   * @dev Retrieves the list of grantees associated with a specific gran
   * @param grantId The unique identifier of the gran
  ...
  /**
   * @dev Retrieves the start date and list of milestone dates for a specific gran
   * @param grantId The unique identifier of the gran
  ...
  /**
   * @dev Retrieves the disbursement details for a specific milestone in a gran
   * @param grantId The unique identifier of the gran
  ...
  /**
   * @dev Retrieves the list of external links associated with a specific gran
   * @param grantId The unique identifier of the gran
