...
interface IERC7699 {
     ...
     *
     * MUST emit this ERCS's {TransferReference} event followed by a corresponding {ERC20.Transfer} even
...
contract ERC20TransferReference is ERC20, IERC7699 {
     ...
     * @param transferReference A bytes field to include a transfer reference, reference signature or other relevan
     * reference data.
    ...
    function transfer(address to, uint256 amount, bytes calldata transferReference) public virtual returns (bool) {
        ...
        // ERC20.Transfer event is emitted immediately after TransferReference even
