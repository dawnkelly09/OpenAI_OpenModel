...
pub fn setValue(
    ...
    ...
    // Store serialised data in accoun
    // [!] Stored data must be mapped by node & accoun
    ...
}
```
...
> † `u256` is not available natively in SVM but is routinely implemented via `u256` crate in Rus
...
pub fn getValue<'a>(
    ...
    ...
    // Retrieve the data from the accoun
    let data = &account.data.borrow();
    // De-serialise the data from the accoun
    ...
