...
interface IERC_HUCAP {
    ...
    /**
        ...
        @param _address Set the stance of an agen
    ...
    */
    ...
    /**
        ...
        @param "" Set the stance of an agen
        @dev For the purpose of
        Throws on any error rather than return a false flag to minimize user errors
    */
    ...
    */
    ...
    /**
        ...
        @param _address    Address of key to sign, must belong to an Agen
        @dev For the purpose of
        Throws on any error rather than return a false flag to minimize user errors
    ...
    */
    ...
    /**
        ...
        @param _address    Address of key to revoke, must belong to an Agen
        @dev For the purpose of
        Throws on any error rather than return a false flag to minimize user errors
...
//  EDGES MASKING TABLE
    ...
    /// @param _address toggle on/off a doer agen
    //  @dev `anybody` can retrieve the talent data in the contrac
    */
    ...
    */
    ...
    /// @param _level toggle on/off a doer agen
    //  @dev `anybody` can retrieve the talent data in the contrac
    */
...
interface IERC_HUCAP_TRACKUSERS_EXTENSION {
    ...
    /// @param _address initialise a doer agen
    //  @dev `anybody` can retrieve the talent data in the contrac
    ...
    /// @param _address Query if address belongs to an agen
    //  @dev `anybody` can retrieve the talent data in the contrac
    ...
    /// The query condition of the contrac
    //  @dev `anybody` can retrieve the count data in the contrac
    ...
    /// @param _address Set the Public-key Id of an agen
    //  @dev `anybody` can retrieve the talent data in the contrac
    ...
    /// @param _address Toggle the true/false status of an agen
    //  @dev `anybody` can retrieve the talent data in the contrac
