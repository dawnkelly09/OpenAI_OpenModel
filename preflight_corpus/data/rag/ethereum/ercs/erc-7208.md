 ...
 * -- IIIIIIII - 32 bit implementation-specific id of the DataPoin
 * - Chain ID (bytes4)
 * -- HHHHHHHH - 32 bit of chain identifier
 * - REGISTRY Address (bytes20)
 * -- AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA - Address of Registry which allocated the DataPoin
**/
```
...
interface IDataObject {
     ...
     * @param dp Identifier of the DataPoin
...
interface IDataPointRegistry {
  ...
  /**
     * @notice Verifies if an address has an Admin role for a DataPoin
     * @param dp DataPoin
     ...
     * @param owner Owner of the new DataPoin
...
interface IDataIndex {
    /**
     * @notice Verifies if DataManager is allowed to write specific DataPoint on specific DataObjec
     * @param dp Identifier of the DataPoin
    ...
    /**
     * @notice Defines if DataManager is allowed to write specific DataPoin
     * @param dp Identifier of the DataPoin
     * @param dm Address of DataManager
     * @param approved if DataManager should be approved for the DataPoin
    ...
    /**
     * @notice Reads stored data
     * @param dobj Identifier of DataObjec
     * @param dp Identifier of the datapoin
