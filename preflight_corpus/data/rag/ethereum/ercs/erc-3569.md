...
interface SealedMetadata {
  /**
    ...
    @dev
      ...
      - This function MUST emit the Sealed even
  ...
  */
  ...
  /**
    @notice This function returns a boolean stating if the token ID is sealed or no
    @dev This function should throw if the token ID does not exis

    @param tokenId The token ID that will be checked if sealed or no
