---
eip: 7806
title: Minimal intent-centric EOA smart accoun
...
* `header`: The `bytes header` can carry information about how to validate the intent or how to preven
...
* `signatures`: The `bytes signatures` field can support different signing methods. It is NOT REQUIRED tha
...
### Validation in the Standard Contrac
...
library PackedIntent {
    /// @notice getSenderAndStandard is a function that gets the sender and standard from the inten
    /// @param intent The intent to get the sender and standard from
    /// @return sender The sender of the inten
    /// @return standard The standard of the inten
    ...
    /// @notice getLengths is a function that gets the lengths from the inten
    ...
    /// @notice getSignatureLength is a function that gets the signature length from the inten
    ...
    /// @notice getIntentLength is a function that gets the intent length from the inten
...
/// @notice VALIDATION_DENIED is the magic value of denied inten
bytes4 public constant VALIDATION_DENIED = 0x00000000;

/// @notice VALIDATION_APPROVED is the magic value of validated inten
...
contract RelayedExecutionStandard is HashGatedStandard {
    ...
    function validateUserIntent(bytes calldata intent) external view returns (bytes4) {
        ...
        // out token amount, use uint128 to shorten the inten
    ...
    function sampleERC20Execution(
        address token, address receiver, uint256 amoun
...
contract StandardRegistry {
    ...
    /// @notice The domain separator of this contrac
    bytes32 public immutable DOMAIN_SEPARATOR;
    /// @notice The type hash of the signed data of this contrac
    ...
    /// @notice The constructor of this contrac
    constructor() {
    ...
    /// @param standard The standard to permi
