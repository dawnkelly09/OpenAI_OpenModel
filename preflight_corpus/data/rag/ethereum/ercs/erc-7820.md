...
interface IAccessControlRegistry {
    ...
    // @param _admin The address who unregistered the contrac
    ...
    //MUST revert if the registered contract doesn't exis
...
contract AccessControlRegistry is IAccessControlRegistry {
    ...
    // Modifier to check if the caller is an admin of the contrac
    ...
    // Retrieves information of a registered contrac
    // _contract: Address of the contrac
    ...
    // Gets role information for an account and contrac
    // targetContract: Address of the target contrac
    // account: Address of the accoun
    ...
    // Internal function to grant a role to an account for a contrac
    function _grantRole(
        address targetContract,
        bytes32 role,
        address accoun
    ...
    // Internal function to revoke a role from an account for a contrac
    ...
    // Checks if the caller is an admin for the contrac
    // _contract: Address of the contrac
