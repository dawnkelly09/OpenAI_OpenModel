...
interface IERC5727 is IERC3525, IERC5192, IERC5484, IERC4906 {
     ...
     * @dev MUST revert if the `tokenId` does not exis
     ...
     * @param tokenId The token id
     * @param amount The amount of the credi
     * @param data The additional data used to issue the credi
     */
    function issue(
        uint256 tokenId,
        uint256 amount,
     ...
     * @param tokenId The token id
     * @param amount The amount of the credi
     * @param data The additional data used to revoke the credi
     */
    function revoke(
        uint256 tokenId,
        uint256 amount,
...
interface IERC5727Governance is IERC5727 {
     ...
     * @param tokenId The id of the token to min
     * @param amount The amount of the token to min
     * @param slot The slot of the token to min
     * @param burnAuth The burn authorization of the token to min
...
interface IERC5727Expirable is IERC5727, IERC5643 {
     ...
     * @param tokenId The token whose expiry date is se
     * @param expiration The expire date to se
