...
standard proposes a set of interfaces for proxies to signal how they work and wha
...
The returned code address is the address the proxy would delegate calls to at tha
