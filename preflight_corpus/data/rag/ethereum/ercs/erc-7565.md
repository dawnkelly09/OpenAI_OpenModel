...
```solidity
    interface IPerpetualContractNFT {
        ...
        // @return loanDueDate The due date for the loan repaymen
        ...
        // @param tokenId The NFT used as collateral
        // @return The total amount required to repay the loan, including interes
...
contract PerpetualContractNFT is ERC4907, IPerpetualContractNFT {
    ...
    function repayLoan(uint256 tokenId, uint256 repayAmount) public override {
        ...
        // Calculate the total amount due for repaymen
        uint256 totalDue = viewRepayAmount(tokenId);

        // Check if the repayAmount is sufficient to cover at least a part of the total due amoun
        require(repayAmount <= totalDue, "Repay amount exceeds total due.");

        // Calculate the remaining loan amount after repaymen
