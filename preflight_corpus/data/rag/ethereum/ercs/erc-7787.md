...
interface SDG {
   ...
   * This function calculates the voting units based on the last time it was updated and decays i
   * over time.
...
import { Ownable } from "@openzeppelin/contracts/access/Ownable.sol"; // Oz Ownable contrac
