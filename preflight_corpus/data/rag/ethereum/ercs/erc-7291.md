...
```solidity
    ...
    /// MUST Emit the {NewPBMTypeCreated} even
...
interface IComplianceGuard {
    ...
    /// @param addresses An array of merchant wallet addresses that was just added or removed from Merchant/Redeemer whitelis
    ...
    /// @param action Tags "add" or "remove" for action type
    /// @param addresses An array of wallet addresses that was just added or removed from address blacklis
    /// @param metadata Optional comments or notes about the added or removed addresses.
...
interface IPBMRC1 is IERC173, IERC5679Ext1155 {
    ...
    /**
        ...
        - caller should have the necessary amount of the sovTokens required to min
