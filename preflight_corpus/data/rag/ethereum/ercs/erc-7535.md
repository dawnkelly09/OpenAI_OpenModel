---
eip: 7535
title: Native Asset ERC-4626 Tokenized Vaul
description: ERC-4626 Tokenized Vaults with Ether (Native Asset) as the underlying asse
...
* not enforcing any behaviors or lack thereof for `fallback`/`__default__` methods, payability on additional vault functions, or handling ETH forcibly sent to the contrac
...
### Allowing assets Parameter to be Ignored in a Deposi
...
### Allowing msg.value to Not Equal assets Output in a Min
