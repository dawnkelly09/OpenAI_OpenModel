...
contract ExampleTransparentContract {
  // owner of the contrac
  address internal contractOwner;
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);

  // maps functions to the delegate contracts that execute the functions
  // funcId => delegate contrac
...
```
### Function Signatures String Forma
...
interface ERC1538Query {
  ...
  /// @notice Gets all the function signatures of functions supported by the transparent contrac
  /// @return A string containing a list of function signatures
  function functionSignatures() external view returns(string memory);
	
  /// @notice Gets all the function signatures supported by a specific delegate contrac
  ...
  /// @param _functionId The id of the function to get information abou
  ...
  /// @notice Get all the delegate contract addresses used by the transparent contrac
...
### How To Deploy A Transparent Contrac
