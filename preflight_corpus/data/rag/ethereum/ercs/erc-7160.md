...
**The multi-metadata extension is OPTIONAL for [ERC-721](./eip-721.md) contracts and it is RECOMMENDED to be used in conjunction with the [ERC-4906](./eip-4906.md) standard if implemented**.
...
interface IERC7160 {
  ...
  /// @param tokenId The identifier for the nf
  ...
  /// @return pinned A boolean showing if the token has pinned metadata or no
  ...
  /// @dev This call MUST revert if the token does not exis
  /// @dev This call MUST emit a `TokenUriPinned` even
  /// @dev This call MAY emit a `MetadataUpdate` event from ERC-4096
  /// @param tokenId The identifier of the nf
  ...
  /// @dev This call MUST revert if the token does not exis
  /// @dev This call MUST emit a `TokenUriUnpinned` even
  /// @dev This call MAY emit a `MetadataUpdate` event from ERC-4096
  ...
  /// @param tokenId The identifier of the nf
  /// @return pinned A bool specifying if a token has metadata pinned or no
