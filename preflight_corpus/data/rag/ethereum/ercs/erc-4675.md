...
description: Fractionalize multiple NFTs using a single contrac
...
interface IMFNFT {
    ...
    */
    ...
    /**
        ...
        @param _value   Transfer amoun
        @return         True if transfer was successful, false if no
    */
    ...
    /**
        ...
        @param _id      ID of the token type
        @param _value   Approval amoun
        @return         True if approval was successful, false if no
    */
