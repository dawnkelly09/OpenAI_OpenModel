...
```js
/// @title IRegistry
/// @dev Implements the registry contrac
interface IRegistry {
    /// @dev Registers a new hook event by a publisher
    /// @param publisherContract The address of the publisher contrac
    ...
    /// @param publisherAddress The address of the publisher contrac
    /// @param threadId The id of the thread these hook events will be fired on
    ...
    /// @dev Update a previously registered hook even
    ...
    /// @dev Remove a previously registered hook even
    /// @param publisherContract The address of the publisher contrac
    /// @param threadId The id of the thread these hook events will be fired on
    /// @param signingKey The public key used to verify the hook signatures
    /// @return Returns true if the hook is successfully updated
    ...
    /// @dev Registers a subscriber to a hook even
    /// @param publisherContract The address of the publisher contrac
    ...
    /// @dev Removes a subscription to a hook even
    /// @param publisherContract The address of the publisher contrac
    /// @param subscriberContract The address of the contract subscribing to the event hooks
    /// @param threadId The id of the thread these hook events will be fired on
...
```js
/// @title IPublisher
/// @dev Implements a publisher contrac
interface IPublisher {
    /// @dev Example of a function that fires a hook event when it is called
    /// @param payload The actual payload of the hook even
    ...
    /// @param blockheight The blockheight that the hook was fired a
...
```js
/// @title ISubscriber
/// @dev Implements a subscriber contrac
