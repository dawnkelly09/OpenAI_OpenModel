...
interface IPoll {
    ...
    /// @dev limit the proposal count to 32 (for practical reasons), loop and generate the proposal lis
    ...
    /// @param _to the person who can vote/no
    ...
    /// @dev use a struct to keep a track of voteWeights and voterCoun
    /// @param _proposalId the index of the proposal in the proposals array
    ...
    /// @dev limit the proposal count to 32 (for practical reasons), loop and generate the vote tally lis
    ...
    /// @dev limit the proposal count to 32 (for practical reasons), loop and generate the vote count lis
    ...
    /// @return an integer which specifies the above mentioned amoun
