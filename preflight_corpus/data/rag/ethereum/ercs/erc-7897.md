...
interface IERC7897Registry {
     ...
     * @notice Emitted when a wallet-linked service is successfully deployed.
       * @param deployedService The address of the deployed contrac
       * @param serviceImplementation The address of the implementation contrac
       * @param salt The salt used for the CREATE2 operation
       * @param chainId The chain ID where the contract is deployed
       * @param wallet The address of the ERC-4337 walle
       */
    ...
    /**
     * @notice Computes the expected wallet-linked service address for an ERC-4337 walle
...
interface IERC7897Service {
  /**
  * @notice Returns the wallet linked to the contrac
  * @return chainId The chainId of the walle
  * @return wallet The address of the [ERC-4337](./eip-4337.md) walle
  */
