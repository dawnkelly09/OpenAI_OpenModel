...
interface OpaqueToken {
   ...
   * @param basketsIn baskets that are restructured and no longer exis
   ...
   * @param basketsIn supply baskets that are restructured and no longer exis
   ...
   * in output baskets. In order to ensure the integrity, external oracle service is required tha
