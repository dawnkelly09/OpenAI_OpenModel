---
eip: 820
title: Pseudo-introspection Registry Contrac
...
### [ERC-820] Registry Smart Contrac

> This is an exact copy of the code of the [ERC820 registry smart contract].

``` solidity
/* ERC820 Pseudo-introspection Registry Contrac
 ...
 *
 * To the extent possible under law, the author(s) have dedicated all copyrigh
...
/// @title ERC820 Pseudo-introspection Registry Contrac
...
### Single-use Registry Deployment Accoun
...
[William Entriken]: https://github.com/fulldecen
