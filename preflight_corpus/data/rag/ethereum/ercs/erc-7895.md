...
```typescrip
// Previously deployed account, i.e. wallet "imports" accoun
type DeployedAccount = {
  type: "deployed";
  // Required: address of the accoun
  address: `0x${string}`;
  keys: never;
  chainId?: '0x{string}';
  factory?: never;
...
// Undeployed account, app creates the accoun
type UndeployedAccount = {
  type: "undeployed";
  address: `0x${string}`;
  keys: never;
  chainId?: '0x{string}'; // in Hex
  // Required: factory address to create the accoun
  factory: `0x${string}`;
  // Required: factory calldata for the accoun
