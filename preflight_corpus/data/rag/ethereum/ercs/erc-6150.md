...
- Complete on-chain storage of hierarchy, which can also be governed on-chain by additional DAO contrac
...
- Easy-to-understand interfaces for developers, which are similar to Linux filesystem commands in concep

The use cases can include:

- On-chain forum, like Reddi
...
interface IERC6150Burnable is IERC6150 {
     ...
     * @param tokenId The token to be burn
     */
     ...
     * @param tokenIds The tokens to be burn
     */
...
interface IERC6150AccessControl is IERC6150 {
    ...
    /**
     * @notice Check whether the specified token can be burnt by specified accoun
