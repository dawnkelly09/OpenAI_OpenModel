...
interface ERC2980 extends ERC20 {
  ...
  /**
  * @dev getter to determine if address is in frozenlis
  */
  function frozenlist(address _operator) external view returns (bool);

  /**
  * @dev getter to determine if address is in whitelis
  */
...
Interface Whitelistable {
  ...
  /**
   * @dev add an address to the whitelis
   * Throws unless `msg.sender` is an Issuer operator
   * @param _operator address to add
   * @return true if the address was added to the whitelist, false if the address was already in the whitelis
   */
  function addAddressToWhitelist(address _operator) external returns (bool);

  /**
   * @dev remove an address from the whitelis
   * Throws unless `msg.sender` is an Issuer operator
...
Interface Freezable {
  ...
  /**
   * @dev add an address to the frozenlis
   * Throws unless `msg.sender` is an Issuer operator
   * @param _operator address to add
   * @return true if the address was added to the frozenlist, false if the address was already in the frozenlis
   */
  function addAddressToFrozenlist(address _operator) external returns (bool);

  /**
   * @dev remove an address from the frozenlis
   * Throws unless `msg.sender` is an Issuer operator
   * @param _operator address to remove
