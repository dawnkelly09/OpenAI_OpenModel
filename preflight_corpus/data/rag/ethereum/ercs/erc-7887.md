...
description: Extension of ERC-7540 with cancelation suppor
...
```yaml
- name: pendingCancelDepositReques
  type: function
...
```yaml
- name: claimableCancelDepositReques
  type: function
  stateMutability: view
...
```yaml
- name: pendingCancelRedeemReques
  type: function
  stateMutability: view
...
```yaml
- name: claimableCancelRedeemReques
  type: function
  stateMutability: view
