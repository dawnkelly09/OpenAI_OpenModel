...
interface IPermissionVerifier {
    /**
     * @dev Check if the signer key format is correc
     */
...
interface IRecoveryPolicyVerifier {
     ...
     * Verification includes checking if guardians exist in the Guardians Lis
     */
...
interface IRecoveryAccount {
    ...
    /**
     * @dev Get wallet recovery config, check if an identity is a guardian, get the nonce of social recovery, and get the recovery status of the walle
     */
