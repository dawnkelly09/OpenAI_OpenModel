---
eip: 7730
title: Structured Data Clear Signing Forma
...
* `@.value` refers to the enclosing transaction native currency amoun
...
* A simple string with human-readable conten
...
Let's assume the following solidity contrac
...
* Avoid using a well-formed, trusted ERC-7730 file on data that should not be formatted using i
