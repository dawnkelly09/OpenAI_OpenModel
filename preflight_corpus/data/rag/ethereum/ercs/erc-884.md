...
This will be extended as follows:
    ...
    contract ERC884 is ERC20 {
         ...
         *  reissued to a new address.  This is the equivalent of issuing replacemen
         *  share certificates.
         ...
         *  Upon successful addition of a verified address, the contract must emi
         ...
         *  Upon successful update of a verified address the contract must emi
        ...
        /**
         *  The `transfer` function MUST NOT allow transfers to addresses tha
        ...
        /**
         *  The `transferFrom` function MUST NOT allow transfers to addresses tha
         *  have not been verified and added to the contract.
         *  If the `to` address is not currently a shareholder then it MUST become one.
