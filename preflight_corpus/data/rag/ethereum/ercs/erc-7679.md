...
interface IUserOperationBuilder {
     ...
     * the executions.
     * @param smartAccount is the address of the UserOp sender.
     * @param executions are (destination, value, callData) tuples tha
    ...
    /**
     * @dev Returns a correctly encoded signature, given a UserOp tha
