...
### Token Upgrade Interface Contrac
``` solidity
interface IEIP4931 {
```
#### Methods
...
/// @return The address of the source token contrac
...
/// @return The address of the destination token contrac
