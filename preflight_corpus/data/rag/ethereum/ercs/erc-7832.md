...
interface IERC7832 is IERC721 {
    ...
    // Function to get the maximum mints a user can perform during his progressive discount cycle per min
    ...
    // Allow ADMIN_ROLE pause the contrac
    function pause() external;

    // Allow ADMIN_ROLE unpause the contrac
    function unpause() external;

    // Allow CREATOR_ROLE to min
    ...
    // Allow ADMIN_ROLE to withdraw funds from the contrac
