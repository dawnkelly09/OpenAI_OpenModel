...
abstract contract ERC3440 is ERC721URIStorage {
     ...
     * @param `uint256 tokenId` the nft id of the original prin
     */
     ...
     * @param `string memory _tokenURI` the metadata attached to each nf
     */
     ...
     * @returns `bool` true if signed by artis
     * The artist may broadcast signature out of band that will verify on the nf
     */
