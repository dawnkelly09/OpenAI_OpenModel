...
extracting address data appended from an untrusted contract. This could resul
in a forged address.
...
* Without a standard contract interface, there is no standard way for a clien
...
* Without the ability to leverage a trusted forwarder every recipient contrac
...
* Making the contract interface agnostic to the internal implementation
  details of the trusted forwarder, makes it possible for a recipient contrac
