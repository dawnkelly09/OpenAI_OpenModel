...
interface IERC721Guarantee /*is IERC721*/{
    ...
    ///           Throws if `_tokenId` is not a valid NFT or userGuaranteed is not righ
...
- Keeping the number of guarantee groups (DAOs)in the interfaces to prevent contract bloa
