...
interface ERC173 /* is ERC165 */ {
    ...
    /// @notice Set the address of the new owner of the contrac
    /// @param _newOwner The address of the new owner of the contrac
...
interface ERC1261Metadata /* is ERC1261 */ {
    /// @notice A descriptive name for a collection of MVTs in this contrac
    function name() external view returns (string _name);

    /// @notice An abbreviated name for MVTs in this contrac
