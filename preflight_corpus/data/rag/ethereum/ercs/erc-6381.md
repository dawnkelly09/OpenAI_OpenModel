...
interface IERC6381 /*is IERC165*/ {
     ...
     * @param collection Address of the collection containing the token being checked for emoji coun
     * @param tokenId ID of the token to check for emoji coun
     * @param emoji Unicode identifier of the emoji
     ...
     * @param collections An array of addresses of the collections containing the tokens being checked for emoji coun
     * @param tokenIds An array of IDs of the tokens to check for emoji coun
     ...
     * @return A boolean value indicating whether the `emoter` has used the `emoji` on the token (`true`) or no
     *  (`false`)
     */
     ...
     *  else.
     * @param collection The address of the collection smart contract containing the token being emoted a
     ...
     *  else.
     * @param collections An array of addresses of the collection smart contracts containing the tokens being emoted a
     ...
     * @param collection Address of the collection containing the token being emoted a
     * @param tokenId ID of the token being emoted
     * @param emoji Unicode identifier of the emoji
     * @param state Boolean value signifying whether to emote (`true`) or undo (`false`) emote
     */
     ...
     * @param collections An array of addresses of the collections containing the tokens being emoted a
     * @param tokenIds An array of IDs of the tokens being emoted
     * @param emojis An array of unicode identifiers of the emojis
     * @param states An array of boolean values signifying whether to emote (`true`) or undo (`false`) emote
     */
...
- `DOMAIN_SEPARATOR` - The domain separator of the Emotable repository smart contrac
- `collection` - Address of the collection containing the token being emoted a
