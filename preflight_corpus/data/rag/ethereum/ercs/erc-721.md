...
interface ERC721 /* is ERC165 */ {
    ...
    ///  `onERC721Received` on `_to` and throws if the return value is no
...
interface ERC721TokenReceiver {
    ...
    /// @dev The ERC721 smart contract calls this function on the recipien
...
interface ERC721Metadata /* is ERC721 */ {
    /// @notice A descriptive name for a collection of NFTs in this contrac
    function name() external view returns (string _name);

    /// @notice An abbreviated name for NFTs in this contrac
...
interface ERC721Enumerable /* is ERC721 */ {
    /// @notice Count NFTs tracked by this contrac
...
- Implements using the OpenZeppelin project forma
...
1. RFC 2119 Key words for use in RFCs to Indicate Requirement Levels. https://www.ietf.org/rfc/rfc2119.tx
