...
- NFT-based yield-farming. Adopting the standard enables the "staker" (owner of the NFT) to have access to the utility benefits even after transferring his NFT to the staking contrac
...
- Keeping the number of functions in the interfaces to a minimum to prevent contract bloa
- Simplicity
- Gas Efficiency
