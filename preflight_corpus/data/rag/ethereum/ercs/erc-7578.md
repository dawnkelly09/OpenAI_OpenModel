...
- **Asset holder**: identification of legal owner of underlying physical asse
...
- **Storage location**: identification of storage location of underlying physical asse
...
- **Declared value**: value of the underlying asse
...
/**
 * @notice Struct encapsulating fields required to by the ERC-7578 standard to represent the physical asse
 * @param tokenIssuer The network or entity minting the token
 * @param assetHolder The legal owner of the physical asse
...
/**
 * @notice Struct encapsulating fields describing the declared value of the physical asse
 * @param currency The currency of the amoun
 * @param value The value of the amoun
 */
struct Amount {
    string currency;
    uint256 value;
...
/**
 * @notice Required interface of an ERC-7578 compliant contrac
 */
interface IERC7578 {
    /**
     * @notice Emitted when the properties of the `tokenId` token are se
     ...
     * @dev Does NOT revert if token doesn't exis
...
contract ERC7578 is ERC721, IERC7578 {
     ...
     *
     * Emits a {PropertiesRemoved} even
     */
