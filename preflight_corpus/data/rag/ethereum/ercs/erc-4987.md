...
interface IERC20Holder is IERC165 {
  /**
   * @notice emitted when the token is transferred to the contrac
   * @param owner functional token owner
   * @param tokenAddress held token address
   * @param tokenAmount held token amoun
   */
  event Hold(
...
```solidity
   ...
   * @param tokenId token id of interes
   */
  function getOwner(uint256 tokenId) external view returns (address) {
    ...
    // check for token holder interface suppor
