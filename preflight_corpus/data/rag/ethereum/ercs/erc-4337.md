...
```solidity
// return the deposit of an accoun
function balanceOf(address account) public view returns (uint256);

// add to the deposit of the given accoun
function depositTo(address account) public payable;

// add to the deposit of the calling accoun
receive() external payable;

// withdraw from the deposit of the current accoun
...
When changing the underlying implementation, all Accounts MUST ensure that there are no conflicts in the storage layou
