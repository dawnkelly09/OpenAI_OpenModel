...
contract AbstractERC918 is EIP918Interface {
    ...
    // the current mining targe
    uint public miningTarget;

    // cumulative counter of the total minted tokens
    uint public tokensMinted;

    // number of blocks per difficulty readjustmen
    ...
    function mint(uint256 nonce) public returns (bool success) {
        ...
        // increment the minted tokens amoun
...
Public interface function hash, meant to be overridden in implementation to define hashing algorithm and validation. Returns the validated diges
...
contract ERC918DelegatedMint is AbstractERC918, ECDSA {
   /**
     * @notice Hash (keccak256) of the payload used by delegatedMin
