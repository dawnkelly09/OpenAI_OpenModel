...
interface IAvatar {
    ...
    /// @param prevModule Address that pointed to the module to be removed in the linked lis
...
/// @title Guardable - A contract that manages fallback calls made to this contrac
contract Guardable {
