...
* Update Royalty Account ownership with payou
...
* extract `tokenType` from the Sub Accoun
...
/// @param allowedTokenTypes is the array of allowed tokens for paymen
...
/// @param RASubAccount[] is an array of data structures containing the information of the royalty sub accounts associated with the royalty accoun
...
```
/// @dev Function to delete a Royalty Accoun
/// @param tokenId is the identifier of the NFT to which the Royalty Account to be updated is attached
...
```
/// @dev Function to make a NFT direct sales or exchange-mediate sales paymen
/// @param receiver is the address of the receiver of the paymen
/// @param seller is the address of the NFT seller
/// @param tokenIds are the tokenIds of the NFT to be bough
...
/// @param tokenType is the type of payment token used in the paymen
...
/// @param tokenId is a tokenId included in the sale and used to look up the associated Royalty Accoun
...
```
/// @dev Function to payout a royalty paymen
...
/// @param receiver is the address to receive the payou
/// @param amount is the amount to be paid ou
