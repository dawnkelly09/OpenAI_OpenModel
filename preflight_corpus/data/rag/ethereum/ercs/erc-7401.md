...
This proposal fixes the inconsistency in the [ERC-6059](./eip-6059.md) interface specification, where interface ID doesn't match the interface specified as the interface evolved during the proposal's lifecycle, but one of the parameters was not added to it. The missing parameter is, however, present in the interface ID. Apart from this fix, this proposal is functionally equivalent to [ERC-6059](./eip-6059.md).
...
interface IERC7059 /* is ERC165 */ {
     ...
     *  MUST be the address of this accoun
     */
    struct DirectOwner {
        uint256 tokenId;
     ...
     * @return tokenId ID of the child token in the child token's collection smart contrac
     * @return contractAddress Address of the child token's smart contrac
     */
    struct Child {
        uint256 tokenId;
     ...
     * @param childAddress Address of the proposed child token's collection smart contrac
     * @param childId ID of the child token in the child token's collection smart contrac
     */
    event ChildProposed(
        uint256 indexed tokenId,
        uint256 childIndex,
     ...
     * @param childAddress Address of the child token's collection smart contrac
     * @param childId ID of the child token in the child token's collection smart contrac
     */
    event ChildAccepted(
        uint256 indexed tokenId,
     ...
     * @return bool The boolean value signifying whether the owner is an NFT or no
     */
     ...
     *  pending array)
     * @param childAddress Address of the child token's collection smart contrac
     * @param childId ID of the child token in its own collection smart contrac
     ...
     * @param to Address of the receiving token's collection smart contrac
     * @param tokenId ID of the token being transferred
     * @param destinationId ID of the token to receive the token being transferred
     * @param data Additional data with no specified forma
     */
...
### Propose-Commit pattern for child token managemen
...
4. **Transfer the child token to an EOA or an `ERC721Receiver`**
![Transfer child token to EOA](../assets/eip-7401/img/eip-7401-transfer-child-to-eoa.png)
5. **Transfer the child token into a new parent token**
