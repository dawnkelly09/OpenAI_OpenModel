---
eip: 1388
title: Attestation Issuers Management Lis
 ...
 contract ManagedListERC
    {
       ...
       * An issuer in the list is represented by their contrac
	   ...
	   * by issuers on that list is accepted. Furthermore, if tha
      ...
      // find which list the sender is managing, then add an issuer to i
      function addIssuer(address issuerContractAddress) public;

      //return false if the list identified by the sender doesn't have this issuer in the lis
