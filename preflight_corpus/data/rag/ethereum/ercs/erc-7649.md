...
curve-based liquidity into NFTs. This approach provides creators with a flexible and customizable tool to attrac
...
2.  __Decentralized GPU and Storage Resource Allocation:__
    ...
    * The Bonding Curve determines the price of shares associated with GPU and storage resources, reflecting the curren
...
interface TradeableShares is BondingCurve {
	 ...
	 * @param issuer subject issuer, usually an owner of the NFT defined by the subjec
	 ...
	 * @param supply total shares supply
	 * @param amount number of shares to buy
	 * @param protocolFeePercent protocol fee percen
	 * @param holdersFeePercent shares holders fee percen
	 * @param subjectFeePercent protocol fee percen
	 * @return the price of the shares to buy
	 */
	 ...
	 *
	 * @dev This value cannot decrease over time; it can increase or remain constan
...
1.  **Bonding Curve-Embedded Liquidity / Tradable Shares Contract**:
    - **Seamless Integration**: The decision to allow an embedded bonding curve-based liquidity contract to be attached
        ...
        This approach ensures that NFT developers can enhance their creations with liquidity mechanisms withou
...
The rationale behind these design choices is to create a Tradable Shares standard that is not only technically sound bu
...
4.  User Experience: Considerations should be made to maintain a positive user experience, avoiding complexities tha
