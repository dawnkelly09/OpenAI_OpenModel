...
* **[EREP-011]** REMOVED
* **[EREP-015]** A `paymaster` should not have its opsSeen incremented in case of a failure of factory or accoun
...
A `UserOperation` that fails the initial validation by a receiving node without entering its mempool is no
