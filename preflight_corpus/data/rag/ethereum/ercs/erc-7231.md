...
interface IERC7231 {
     ...
     * @param id nft id
     * @param identitiesRoot new identity roo
     */
    event SetIdentitiesRoot(
        uint256 id,
        bytes32 identitiesRoo
    );

    /**
     * @notice
     * @dev set the user ID binding information of NFT with identitiesRoo
     * @param id nft id
     ...
     * @param id nft id
     * MUST return the bytes32 multiUserIDsRoo
