...
### Composable Transfer Function Parameter Forma
...
interface ERC998ERC721TopDown {
  ...
  /// @param _childContract The ERC-721 contract of the child token.
  /// @param _childTokenId The tokenId of the token that is being transferred.
  /// @param _data Additional data with no specified forma
  function safeTransferChild(
    uint256 _fromTokenId,
    address _to,
    address _childContract,
...
interface ERC998ERC721TopDownEnumerable {
  ...
  /// @param _tokenId The parent token of child tokens in child contrac
  /// @param _index The index position of the child contrac
...
interface ERC998ERC20TopDown {
  ...
  /// @notice Look up the balance of ERC-20 tokens for a specific token and ERC-20 contrac
  /// @param _tokenId The token that owns the ERC-20 tokens
  /// @param _erc20Contract The ERC-20 contrac
  /// @return The number of ERC-20 tokens owned by a token from an ERC-20 contrac
  function balanceOfERC20(
    uint256 _tokenId,
    address _erc20Contrac
  )
    external
    view
    returns(uint256);
  ...
  /// @param _tokenId The token to transfer from
  /// @param _value The address to send the ERC-20 tokens to
  /// @param _erc223Contract The `ERC-223` token contrac
  /// @param _value The number of ERC-20 tokens to transfer
  /// @param _data Additional data with no specified format, can be used to specify tokenId to transfer to
  ...
  /// @param _erc20Contract The ERC-20 token contrac
  /// @param _value The number of ERC-20 tokens to transfer
  function getERC20(
    address _from,
    uint256 _tokenId,
...
interface ERC998ERC20TopDownEnumerable {
  ...
  /// @return address The ERC-20 contrac
...
interface ERC998ERC721BottomUp {
  ...
  /// @param _fromContract The address of the owning contrac
