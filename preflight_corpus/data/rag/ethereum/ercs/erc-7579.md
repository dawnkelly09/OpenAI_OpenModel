...
interface IERC7579Execution {
     ...
     * If a mode is requested that is not supported by the Account, it MUST rever
     */
 ...
 * @param userOpHash The hash of the PackedUserOperation struc
 *
 * MUST ensure adequate authorization control: i.e. onlyEntryPoin
 */
...
interface IERC7579AccountConfig {
    /**
     * @dev Returns the account id of the smart accoun
     * @return accountImplementationId the account id of the smart accoun
     *
...
interface IERC7579ModuleConfig {
    ...
    /**
     * @dev Installs a Module of a certain type on the smart accoun
     * @param moduleTypeId the module type ID according to the ERC-7579 spec
...
interface IERC7579Validator is IERC7579Module {
     ...
     * @param sender the address that sent the ERC-1271 request to the smart accoun
     * @param hash the hash of the ERC-1271 reques
     * @param signature the signature of the ERC-1271 reques
     *
...
interface IERC7579Hook is IERC7579Module {
     ...
     * @param msgSender the address that called the smart accoun
     * @param value the value that was sent to the smart accoun
     * @param msgData the data that was sent to the smart accoun
     *
