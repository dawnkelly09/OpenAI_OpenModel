...
interface ERC1363 /* is ERC20, ERC165 */ {
   ...
   * @param value uint256 The amount of tokens to be spen
   * @return true unless throwing
   */
...
interface ERC1363Receiver {
   ...
   * @dev Any ERC1363 smart contract calls this function on the recipien
   ...
   * @param data bytes Additional data with no specified forma
