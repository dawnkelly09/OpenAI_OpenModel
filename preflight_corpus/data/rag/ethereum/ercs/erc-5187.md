...
///  Note: the ERC-165 identifier for this interface is 0x6938e358.
 interface IRental /* is IERC165,IERC1155 */ {
     ...
     * - `expire` The specified period of time to ren
     **/
    ...
    *  - `expire` The new specified period of time to ren
    **/
    ...
    **/
    ...
    /**
    * @notice Return expire The specified period of time to ren
    **/
