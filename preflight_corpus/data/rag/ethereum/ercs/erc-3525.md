...
interface IERC3525 /* is IERC165, IERC721 */ {
    ...
    /**
     * @notice Transfer value from a specified token to an address. The caller should confirm tha
...
interface IERC3525SlotEnumerable is IERC3525 /* , IERC721Enumerable */ {
     ...
     * @param _index The index in the slot lis
     ...
     * @param _index The index in the token list of the slo
    ...
    IERC3525 /* , IERC721Metadata */
{
     ...
     * @return The JSON formatted URI of the current ERC-3525 contrac
     */
