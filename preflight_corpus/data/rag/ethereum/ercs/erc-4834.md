...
interface IDomainRegisterable is IDomain {
    ...
    /// @dev        This should revert if `canSetDomain(msg.sender, name, pointer)` is `false` of if the domain doesn't exis
    /// @param      name The subdomain name to be updated
    /// @param      subdomain The subdomain to se
    ...
    /// @param      subdomain The subdomain that would be se
...
interface IDomainAccessControl is IDomain {
    ...
    /// @param      newSubdomain The domain that will be set nex
