...
description: Extension of ERC-4626 with asynchronous deposit and redemption suppor
...
- Request: a request to enter (`requestDeposit`) or exit (`requestRedeem`) the Vaul
...
### Symmetry and Non-inclusion of requestWithdraw and requestMin
...
```solidity
    ...
    function requestDeposit(uint256 assets, address controller, address owner) external returns (uint256 requestId) {
        ...
        requestId = 0; // no requestId associated with this reques

        asset.safeTransferFrom(owner, address(this), assets); // asset here is the Vault underlying asse
