...
/// @param _address The address of the interactive objec
...
/// @param from The initiating objec
/// @param to The receiving objec
/// @param state The state controller contrac
...
interface IERC5050Sender {
    ...
    /// @notice Enable or disable approval for a third party ("operator") to conduc
    ...
    /// @param _operator The address that acts on behalf of the accoun
...
- Sender/receiver contracts can require a specific state contrac
...
interface IControllable {
    ...
    /// @param _action The action selector to query agains
