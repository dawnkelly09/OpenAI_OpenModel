...
/// @title ERC-5218: NFT Rights Managemen
interface IERC5218 is IERC721 {
  ...
  ///  revocation of some ancestral license. In that case, your smart contrac
  ...
  /// @dev A non-existing or revoked license is inactive and this function mus
  ...
  /// @dev Throws unless the queried NFT exists. If the NFT doesn't have a roo
  ...
  /// @dev Throws unless the NFT `_tokenId` exists. Throws unless the paren
  ...
  ///  eligible revoker. This function should be used for revoking both roo
...
```solidity
  ...
  mapping(uint256 => License) private _licenses; // maps from a license identifier to a license objec
