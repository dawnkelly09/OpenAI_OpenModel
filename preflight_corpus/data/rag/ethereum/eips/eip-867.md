...
- No verification script should ever require an unlocked ethereum walle
...
- **toAddress** (*hex string*): The address to which ETH should be sen
...
- **code** (*hex string*): the new bytecode associated with the contrac
