...
* Block validity
  ...
  * Beginning with `TRANSITION_BLOCK`, block rewards aren't added to `beneficiary` accoun
* Client software adheres to PoS LMD-GHOST rule
  * Head and finalized blocks are set according to the recent `POS_FORKCHOICE_UPDATED` even
