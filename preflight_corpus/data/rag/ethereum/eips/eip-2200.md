...
reducing excessive gas costs where it doesn’t match how mos
...
* If *gasleft* is less than or equal to gas stipend, fail the curren
...
* Drop EIP-1283 and abstain from modifying `SSTORE` cos
