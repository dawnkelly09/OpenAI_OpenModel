...
# Constants; chosen to support a 630m block gas limi
MAX_TXS = 30_000
MAX_SLOTS = 300_000
...
# All changes to a single storage slo
...
- Storage keys: lexicographic within each accoun
- Block access indices: ascending within each change lis
...
[
    ...
    [ # AccountChanges for 0x0000000000000000000000000000000000000001 (Block hash contract)
