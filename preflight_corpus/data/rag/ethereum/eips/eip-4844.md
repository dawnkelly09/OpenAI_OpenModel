...
def point_evaluation_precompile(input: Bytes) -> Bytes:
    ...
    # Verify KZG proof with z and y in big endian forma
...
def validate_block(block: Block) -> None:
    ...
    # ensure the total blob gas spent is at most equal to the limi
...
- PBS (proposer/builder separation), to avoid requiring individual validators to process 32 MB of data in one slo
