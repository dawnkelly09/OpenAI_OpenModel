...
- **progressive list**: ordered variable-length homogeneous collection, without limi
  - notation `ProgressiveList[type]`, e.g. `ProgressiveList[uint64]`
- **progressive bitlist**: ordered variable-length collection of `boolean` values, without limi
