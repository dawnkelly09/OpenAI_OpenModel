---
eip: 7804
title: Withdrawal Credential Update Reques
...
address was introduced in Capella, one of the most common questions was abou
...
So the validator's withdrawal credential must be the same address of the smart contrac
creating the request (not the credential of the transaction sender), or the contrac
...
| `SYSTEM_ADDRESS` | `0xfffffffffffffffffffffffffffffffffffffffe` | Address used to invoke system operation on contrac
...
The new withdrawal credential update request operation is an [EIP-7685](./eip-7685.md) reques
...
#### Withdrawal Credentials Update Request Contrac
