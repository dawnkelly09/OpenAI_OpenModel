...
from popular Ethereum clients, we are putting user funds at risk. This is because most walle
interfaces do not expose the chainId to the user, meaning they typically do not have insigh
...
As of the fork block `N`, consider transactions with a `chaindId = 0` to be invalid. Such tha
