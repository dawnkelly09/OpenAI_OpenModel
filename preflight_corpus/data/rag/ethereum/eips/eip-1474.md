...
Returns the version of the current clien
...
Returns the number of peers currently connected to this clien
...
Returns a list of addresses owned by this clien
...
Returns the number of the most recent block seen by this clien
...
{[`Data`](#data)} - return value of executed contrac
...
Returns the coinbase address for this clien
...
Returns a list of all logs based on a filter objec
...
- {[`Data`](#data)} `to` - transaction recipient or `null` if deploying a contrac
...
Returns the number of hashes-per-second this node is mining a
...
{[`Data`](#data)} - signature hash of the transaction objec
...
{`boolean`} - `true` if the filter is found and successfully destroyed or `false` if it is no
