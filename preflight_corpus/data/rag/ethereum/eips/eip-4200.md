...
- `RJUMP`/`RJUMPI`/`RJUMPV` with `JUMPDEST` as targe
    - `relative_offset` is positive/negative/`0`
- `RJUMP`/`RJUMPI`/`RJUMPV` with instruction other than `JUMPDEST` as targe
    - `relative_offset` is positive/negative/`0`
...
- `RJUMP`/`RJUMPI`/`RJUMPV` target another `RJUMP`/`RJUMPI`/`RJUMPV` immediate argumen
