...
## Abstrac
Introduce a new transaction type which includes a list of transactions tha
...
contracts operate. Transactions are able to pass their result to subsequen
...
6. Prepare `Result` to be available via return opcodes in the nex
...
price, the relayer may require the user to sign multiple differen
