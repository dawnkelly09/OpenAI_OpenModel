...
* This is inherently slower than getting this information from the weak subjectivity checkpoin
...
class DepositTestCase:
    ...
    eth1_data: Eth1Data           # An Eth1Data object that can be used to finalize the tree after pushing this deposi
    block_height: uint64          # The height of the execution block with this Eth1Data
    snapshot: DepositTreeSnapshot # The resulting DepositTreeSnapshot object if the tree were finalized after this deposi
```
...
class DepositTree:
    ...
    def from_snapshot(snapshot: DepositTreeSnapshot) -> DepositTree:
        # decent validation check on the snapsho
