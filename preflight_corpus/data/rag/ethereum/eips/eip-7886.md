...
def validate_block(chain: BlockChain, block: Block) -> None:
    # Validate header against paren
    validate_header(chain, block.header)

    # Validate deferred execution outputs from the paren
    ...
    for i, tx in enumerate(map(decode_transaction, block.transactions)):
        ...
        # Verify sender is an EOA or has delegation suppor
...
def process_transactions(
    ...
    # Pre-charge senders for maximum possible gas fees upfron
