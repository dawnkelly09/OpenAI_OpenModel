...
the well" by modifying the block mining algorithm in a low risk manner tha
...
will result in GPU-based mining quickly becoming unprofitable.  Given tha
...
Furthermore, we do not wish to introduce significant algorithm changes tha
...
for formal analysis of the changes by experts. We must weigh this window agains
...
The choice of FNV constants is made based on the formal specification a
...
Typical ASIC synthesis tools would optimize multiplication of a constan
...
implement this new algorithm, and all nodes will require updates to accep
