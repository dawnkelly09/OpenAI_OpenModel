...
type Account {
    ...
    # Code contains the smart contract code for this account, if the accoun
...
type Transaction {
    ...
    createdContract(block: Long): Accoun
...
input BlockFilterCriteria {
    ...
    addresses: [Address!]
    # Topics list restricts matches to particular event topics. Each event has a lis
  # of topics. Topics matches a prefix of that list. An empty element array matches any
  # topic. Non-empty elements represent an alternative that matches any of the
  # contained topics.
  #
  # Examples:
  #  - [] or nil          matches any topic lis
...
type Block {
    ...
    account(address: Address!): Accoun
    # Call executes a local call operation at the current block's state.
    call(data: CallData!): CallResul
