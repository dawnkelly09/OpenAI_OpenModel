...
This creates a safer system for end users. By abstracting each individual reques
...
Each proposal may choose how to extend the beacon chain types to include new EL reques
types.
...
### Removing empty requests in commitmen
