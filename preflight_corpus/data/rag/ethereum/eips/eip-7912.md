...
feature. Previous attempts either required code versioning, like the EVM Objec
...
Both operations take a single argument from the stack, `N`. This argument mus
...
Since `SWAP1` and `DUP1` operate on the top of the stack, it seems fitting tha
