...
This stems from the fact that there is no precompiled contrac
...
The more conservative estimate puts the security of BN256 a
100-bits.
While this is likely still out of reach for many adversaries,
it should give us pause.
This reduced security was noted in the recent MadNe
