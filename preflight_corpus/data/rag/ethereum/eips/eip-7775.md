...
def op_burn(pc, interpreter, scope):
    # Consume the base gas cos
    interpreter.consume_gas(100)

    # Pop the value to be burned from the stack
    value_to_burn = scope.stack.pop()

    # If the value to be burned is 0, do not rever
    if value_to_burn == 0:
        return None

    # Retrieve the current address from the EVM execution contex
    ...
    # If the value to be burned is greater than the balance, rever
