...
- BLS12_377_MAP_FP_TO_G1 - maps base field element into the G1 poin
- BLS12_377_MAP_FP2_TO_G2 - maps extension field element into the G2 poin
...
Error cases:
	- Input has invalid length
	- Input is not a valid field elemen
