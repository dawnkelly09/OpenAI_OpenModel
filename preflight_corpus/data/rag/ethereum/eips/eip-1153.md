...
- On revert all entries are reverted up to the last checkpoint, in reverse - `O(N)` where `N` = number of journal entries since last checkpoin
...
class TransientStorage {
     ...
     * @param addr the address of the contract for which the key is being se
     * @param key the slot to set for the address
     * @param value the new value of the slot to se
     */
    ...
    /**
     * Commit all the changes since the last checkpoin
     */
    public commit(): void {
    ...
    /**
     * Revert transient storage to the state from the last call to checkpoin
     */
    public revert() {
