...
- An input is neither a point on the G1 elliptic curve nor the infinity poin
...
- Invalid coordinate encoding
- An input is neither a point on the G2 elliptic curve nor the infinity poin
- Input has invalid length
...
- Invalid coordinate encoding
- An input is neither a point on its respective elliptic curve nor the infinity poin
- An input is on its respective elliptic curve but not in the correct subgroup
- Input has invalid length

#### ABI for mapping Fp element to G1 poin
...
#### ABI for mapping Fp2 element to G2 poin
...
#### Gas schedule clarifications for the variable-length inpu
