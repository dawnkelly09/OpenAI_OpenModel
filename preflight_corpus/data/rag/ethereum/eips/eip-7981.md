---
eip: 7981
title: Increase access list cos
...
```python
# Standard access list functionality cos
...
# Total access list cos
access_list_cost = standard_access_list_cost + access_list_data_cos
```
