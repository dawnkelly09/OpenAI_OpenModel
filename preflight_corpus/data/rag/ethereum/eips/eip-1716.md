...
- Activation:
  - `Block >= 7_280_000` on the Ethereum Mainne
  - `Block >= 4_939_394` on the Ropsten testne
  - `Block >= 10_255_201` on the Kovan testne
  - `Block >= 4_321_234` on the Rinkeby testne
  - `Block >= 0` on the Görli testne
- Removed EIPs:
