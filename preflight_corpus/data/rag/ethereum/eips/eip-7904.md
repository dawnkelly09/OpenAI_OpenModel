...
### Address and Storage Access Cos
...
const (
  ...
  ExpByteGas          uint64 = 4  // One per byte of the EXP exponen
...
func newRepricedInstructionSet() JumpTable {
  ...
  instructionSet[TLOAD].constantGas = WarmStorageReadCos
  instructionSet[TSTORE].constantGas = WarmStorageReadCos

  validateAndFillMaxStack(&instructionSet)
 return instructionSe
}
...
func memoryGasCost(mem *Memory, newMemSize uint64) (uint64, error) {
 if newMemSize == 0 {
  ...
  if newMemSize > uint64(mem.Len()) {
    ...
    fee := newTotalFee - mem.lastGasCos
