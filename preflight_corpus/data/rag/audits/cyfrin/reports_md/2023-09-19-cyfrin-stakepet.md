...
### Inflation attack can cause early users to lose their deposi
...
- Pete, unfortunately, receives zero ownership while his deposit remains within the contrac
...
### Closedown condition is inconsistent with the stated documentation of majority agreemen
...
**Impact:** The current model can be hijacked by whales who can trigger closedown of contract whenever they wish to. This could create a bad user experience for majority of pet owners who want to stay in the contrac
...
107:     bool public immutable HARDCORE; // Whether the initial collateral is taken if failing to proof of life or no
