...
```solidity
    function test_v3PositionManager_burn_frontrunnable() public {
        ...
        bytes memory commands = abi.encodePacked(
            ...
            bytes1(uint8(Commands.V3_POSITION_MANAGER_CALL)), // collec
...
Let's explore the contracts to spot where and why the MEV protection can be los
...
### Incorrect configuration of `StableInfo` contract address in BSC Testne
