...
```solidity
    function testTradeRightAtMarketClose() public {
        ...
        // This should fail - market transitions to closed due to timeTransitions modifier // NB it doesn'
        // vm.expectRevert(bytes("!ms")); // Market state error
    ...
    function testLiquidityOperationsAtMarketClose() public {
        ...
        // Try to add liquidity at exact close time - should fail // NB it doesn'
        vm.warp(closesAt);
...
```solidity
   function testFrontRunAddLiquidity() public {
        ...
        // bob can now sell for more gaining ~30% of Alice deposi
        vm.prank(bob);
