...
### `AutoRedemption::fulfillRequest` should never be allowed to rever
...
### `USDs` redemption calculation can be manipulated due to unsafe signed-unsigned cas
...
return _quoteAmountOut > _USDCTargetAmoun
    ? _collateralBalance * _USDCTargetAmount / _quoteAmountOu
    : _collateralBalance;
```
...
### Concentrated liquidity tick logic is incorrec
