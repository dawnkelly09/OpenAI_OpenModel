...
👎
Still need to be manually conﬁgured + revoked on compromise
👎
...
API tokens are a major improvement; let’s do even better!
Background
...
15 nitty-gritty time lessons for other possible implementations
...
20
Lesson #2.5: OIDC varies wildly within
IdPs
...
○
High demand for more IdPs/more trust relationships (e.g. reusable GitHub workﬂows)
●
...
○
High and growing “top 20” coverage: urllib3, certiﬁ, cryptography, charset-normalizer, idna, wheel, etc.
Lessons from PyPI
