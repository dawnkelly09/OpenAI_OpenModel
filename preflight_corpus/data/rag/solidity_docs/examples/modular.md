::: index
contract;modular, modular contrac
:::
...
and control the behavior of each module in isolation, the interactions
...
`library <libraries>`{.interpreted-text role="ref"} to check tha
