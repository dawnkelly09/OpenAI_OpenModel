...
seller would like to get some compensation, e.g. Ether, in return. The
...
or the other way. In the following example, both parties have to pu
twice the value of the item into the contract as escrow. As soon as this
happened, the Ether will stay locked inside the contract until the buyer
